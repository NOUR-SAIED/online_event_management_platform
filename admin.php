                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    // Block Button
                                    echo "<form action='block_user.php' method='POST' style='display:inline;'>
                                            <input type='hidden' name='user_id' value='" . $row['id'] . "'>
                                            <button type='submit' class='btn btn-danger btn-sm'>Block</button>
                                          </form>";
                            
                                    // Unblock Button
                                    echo "<form action='unblock_user.php' method='POST' style='display:inline;'>
                                            <input type='hidden' name='user_id' value='" . $row['id'] . "'>
...
<!-- JavaScript to remember the active tab -->
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Add event listener to store the active tab on click
        tabs.forEach(tab => {
